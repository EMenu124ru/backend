    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.TextField(default='', verbose_name='Адрес проживания')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('WAITER', 'Официант'), ('BARTENDER', 'Бармен'), ('COOK', 'Повар'), ('CHEF', 'Шеф-повар'), ('SOUS_CHEF', 'Су-Шеф'), ('MANAGER', 'Управляющий'), ('HOSTESS', 'Хостес')], max_length=64, verbose_name='Роль')),
                ('education', models.TextField(default='', verbose_name='Образование')),
                ('place_of_birth', models.TextField(default='', verbose_name='Место рождения')),
                ('citizenship', models.TextField(default='', verbose_name='Гражданство')),
                ('personnel_number', models.PositiveIntegerField(verbose_name='Табельный номер')),
                ('medical_checkup', models.DateField(default='', verbose_name='Медицинский осмотр')),
                ('employment_contract', models.TextField(default='', verbose_name='Трудовой договор')),
                ('work_experience', models.TextField(default='', verbose_name='Стаж работы')),
                ('restaurant', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='staff', to='restaurants.restaurant', verbose_name='Ресторан')),
