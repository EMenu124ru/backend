...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('WAITER', 'Официант'), ('BARTENDER', 'Бармен'), ('COOK', 'Повар'), ('CHEF', 'Шеф-повар'), ('MANAGER', 'Управляющий'), ('HOSTESS', 'Хостес')], max_length=64, verbose_name='Роль')),
