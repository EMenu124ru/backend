...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.TextField(choices=[('WAITING_FOR_COOKING', 'Ожидает готовки'), ('COOKING', 'Готовится'), ('DONE', 'Готово'), ('DELIVERIED', 'Выдано')], default='WAITING_FOR_COOKING', verbose_name='Статус блюда')),
                ('comment', models.TextField(default='', verbose_name='Комментарий')),
            ],
            options={
