...
def test_create_order_and_dishes_by_cook(
    ...
    order_and_dishes = OrderAndDishesFactory.build(order=order, dish=dish)
...
def test_remove_order_and_dishes_by_cook(
    ...
    assert OrderAndDishes.objects.filter(id=order_and_dishes.id).exists()
...
def test_remove_order_and_dishes_by_waiter(
    ...
    assert not OrderAndDishes.objects.filter(id=order_and_dishes.id).exists()
